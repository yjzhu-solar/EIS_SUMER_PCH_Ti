pro sumer_merg
    ...
    int_merg[0:1023,*] = image_aver[*,6:305]
    ...
    image_aver = image_aver/3.0
    int_merg[1024:2047,*] = congrid(image_aver[*,6:307],1024,300)
    ...
    image_aver = image_aver/3.0
    int_merg[2048:3071,*] = congrid(image_aver[*,29:323],1024,300)
    ...
    image_aver = image_aver/3.0
    int_merg[3072:4095,*] = congrid(image_aver[*,26:324],1024,300)
