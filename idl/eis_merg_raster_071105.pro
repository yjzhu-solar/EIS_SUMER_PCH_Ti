...
filenames = file_search('../raw_data/north_pole/20071105/level1/eis_l1_*.fits')
...
;        print,data->getexp()
;    endif
    save,filename = "../save/new_lvl1_offset_limb_1105_northpole_tilt_cor"+strmid(filenames[ii],23,18,/reverse_offset)+".sav",wvl,new_data_offset,new_err_offset, $
