pro sumer_wvl_cal_375

filenames = file_search('../raw_data/sumer/20071116/level1/sum_r_20071116_09*0375_l1.sav')
...
print,image_yaver[0:10]
print,image_yaver[299:310]
plot,indgen(360),image_yaver
oplot,fltarr(2)+299,!y.crange

spectrum_line_id = mean(image_aver[*,230:279],dimension=2)
